...
from mts.knowledge.export import SkillPackage, _clean_lessons, export_skill_package, list_solved_scenarios
from mts.knowledge.search import _keyword_score, _tokenize, search_strategies
from mts.mcp.tools import MtsToolContext, export_skill, list_solved
from mts.mcp.tools import search_strategies as mcp_search
...
class TestRestApi:
    def test_list_solved_endpoint(self) -> None:
        ...
        from mts.server.knowledge_api import router
